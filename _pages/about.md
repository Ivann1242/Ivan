 ...
 * [Translation-Invariant Total Orders](https://lsa.umich.edu/math/undergraduates/research-and-career-opportunities/research/LoGM/projects.html) under Dr. Grant Barkley's supervision, already shipped a sage math [package](https://github.com/emmaycl/TITO_Explore_package) and a [paper](https://arxiv.org/abs/2607.11709) on arXiv, target to publish on FPSAC 2027.

News
======
* **Apr 2026 – Present** — Co-author on the Structure2Discover task series for [Terminal-Bench Science](https://www.tbench.ai/news/tb-science-announcement).
...
Research Highlights
======
* **Terminal-Bench Science** — Co-author on Structure2Discover benchmark tasks for AI scientific structure discovery. [Announcement](https://www.tbench.ai/news/tb-science-announcement)
* **Hybrid Transformer Analysis** — Studied generalization on the Associative Recall task across Transformer, Mamba, and hybrid architectures with Dr. Samet Oymak. [GitHub](https://github.com/Ivann1242/Analysis-AR-problem)
* **TITO** — Developed algorithms for Translation-Invariant Total Orders with Dr. Grant Barkley. [Project page](https://lsa.umich.edu/math/undergraduates/research-and-career-opportunities/research/LoGM/projects.html) · [arXiv:2607.11709](https://arxiv.org/abs/2607.11709)
* **ThinkAct LLM Agent** — Improved LLM reasoning via self-reflection and self-consistency within the ReAct framework. [GitHub](https://github.com/Ivann1242/ThinkAct)

Selected Honors
======
* **University of Michigan SURE 2026** — Summer Undergraduate Research Experience fellowship
* **Tartanhacks 2026** — Top 5 grant among 300+ submitted projects
* **CAST-USA 33rd Innovation Summit** — Finalist, CAST-USA 33rd Innovation Summit; award presented by Prof. Avi Wigderson, 2023 ACM A.M. Turing Award Laureate
* **University of Pittsburgh NOUR 2025** — Summer Research Scholar, School of Computing and Information
* **She Innovations Hackathon** — Led team to build a 3D runner game in Unity/C#

Contact
======
Feel free to reach out at [ivaning@umich.edu](mailto:ivaning@umich.edu). You can also download my [research resume]({{ site.baseurl }}/files/Yifan_Jing_Research_Resume.pdf).
